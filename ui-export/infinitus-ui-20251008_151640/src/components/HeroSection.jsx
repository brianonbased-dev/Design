...
export const HeroSection = () => {
  return (
    <section className="relative min-h-screen overflow-hidden bg-background pb-16 sm:pb-24">
      {/* Animated background elements - positioned below video */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-2/3 left-1/4 w-96 h-96 bg-primary/10 rounded-full blur-3xl animate-pulse"></div>
